...
struct qt_meta_stringdata_cedar__proc__CppScript_t {
    QByteArrayData data[7];
    char stringdata0[92];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__proc__CppScript_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__proc__CppScript_t qt_meta_stringdata_cedar__proc__CppScript = {
    {
QT_MOC_LITERAL(0, 0, 22), // "cedar::proc::CppScript"
QT_MOC_LITERAL(1, 23, 13), // "scriptStarted"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 13), // "scriptStopped"
QT_MOC_LITERAL(4, 52, 13), // "statusChanged"
QT_MOC_LITERAL(5, 66, 11), // "requestStop"
QT_MOC_LITERAL(6, 78, 13) // "threadStopped"

    },
    "cedar::proc::CppScript\0scriptStarted\0"
    "\0scriptStopped\0statusChanged\0requestStop\0"
    "threadStopped"
};
...
void cedar::proc::CppScript::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CppScript::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CppScript::scriptStarted)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CppScript::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CppScript::scriptStopped)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (CppScript::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CppScript::statusChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject cedar::proc::CppScript::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__proc__CppScript.data,
      qt_meta_data_cedar__proc__CppScript,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::CppScript::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__CppScript.stringdata0))
