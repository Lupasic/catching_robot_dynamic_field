...
struct qt_meta_stringdata_cedar__proc__gui__TriggerItem_t {
    QByteArrayData data[5];
    char stringdata0[82];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__proc__gui__TriggerItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__proc__gui__TriggerItem_t qt_meta_stringdata_cedar__proc__gui__TriggerItem = {
    {
QT_MOC_LITERAL(0, 0, 29), // "cedar::proc::gui::TriggerItem"
QT_MOC_LITERAL(1, 30, 20), // "triggerStateChanging"
QT_MOC_LITERAL(2, 51, 0), // ""
QT_MOC_LITERAL(3, 52, 14), // "triggerStarted"
QT_MOC_LITERAL(4, 67, 14) // "triggerStopped"

    },
    "cedar::proc::gui::TriggerItem\0"
    "triggerStateChanging\0\0triggerStarted\0"
    "triggerStopped"
};
...
const QMetaObject cedar::proc::gui::TriggerItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__proc__gui__TriggerItem.data,
      qt_meta_data_cedar__proc__gui__TriggerItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::gui::TriggerItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__gui__TriggerItem.stringdata0))
