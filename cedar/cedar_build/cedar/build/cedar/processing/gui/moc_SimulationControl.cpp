...
const QMetaObject cedar::proc::gui::SimulationControlPrivate::TriggerControlWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__proc__gui__SimulationControlPrivate__TriggerControlWidget.data,
      qt_meta_data_cedar__proc__gui__SimulationControlPrivate__TriggerControlWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void cedar::proc::gui::SimulationControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SimulationControl::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SimulationControl::signalTriggerCountChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject cedar::proc::gui::SimulationControl::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__proc__gui__SimulationControl.data,
      qt_meta_data_cedar__proc__gui__SimulationControl,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
