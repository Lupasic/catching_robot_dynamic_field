...
struct qt_meta_stringdata_cedar__proc__gui__SettingsDialog_t {
    QByteArrayData data[4];
    char stringdata0[66];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__proc__gui__SettingsDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__proc__gui__SettingsDialog_t qt_meta_stringdata_cedar__proc__gui__SettingsDialog = {
    {
QT_MOC_LITERAL(0, 0, 32), // "cedar::proc::gui::SettingsDialog"
QT_MOC_LITERAL(1, 33, 15), // "changesAccepted"
QT_MOC_LITERAL(2, 49, 0), // ""
QT_MOC_LITERAL(3, 50, 15) // "changesRejected"

    },
    "cedar::proc::gui::SettingsDialog\0"
    "changesAccepted\0\0changesRejected"
};
...
const QMetaObject cedar::proc::gui::SettingsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_cedar__proc__gui__SettingsDialog.data,
      qt_meta_data_cedar__proc__gui__SettingsDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::gui::SettingsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__gui__SettingsDialog.stringdata0))
