...
struct qt_meta_stringdata_cedar__proc__gui__IdeApplication_t {
    QByteArrayData data[4];
    char stringdata0[80];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__proc__gui__IdeApplication_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__proc__gui__IdeApplication_t qt_meta_stringdata_cedar__proc__gui__IdeApplication = {
    {
QT_MOC_LITERAL(0, 0, 32), // "cedar::proc::gui::IdeApplication"
QT_MOC_LITERAL(1, 33, 25), // "showExceptionDialogSignal"
QT_MOC_LITERAL(2, 59, 0), // ""
QT_MOC_LITERAL(3, 60, 19) // "showExceptionDialog"

    },
    "cedar::proc::gui::IdeApplication\0"
    "showExceptionDialogSignal\0\0"
    "showExceptionDialog"
};
...
void cedar::proc::gui::IdeApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (IdeApplication::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IdeApplication::showExceptionDialogSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject cedar::proc::gui::IdeApplication::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_cedar__proc__gui__IdeApplication.data,
      qt_meta_data_cedar__proc__gui__IdeApplication,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::gui::IdeApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__gui__IdeApplication.stringdata0))
