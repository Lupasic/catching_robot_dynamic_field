...
struct qt_meta_stringdata_cedar__proc__gui__GroupParameterDesigner_t {
    QByteArrayData data[13];
    char stringdata0[212];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__proc__gui__GroupParameterDesigner_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__proc__gui__GroupParameterDesigner_t qt_meta_stringdata_cedar__proc__gui__GroupParameterDesigner = {
    {
QT_MOC_LITERAL(0, 0, 40), // "cedar::proc::gui::GroupParame..."
QT_MOC_LITERAL(1, 41, 20), // "customParameterAdded"
QT_MOC_LITERAL(2, 62, 0), // ""
QT_MOC_LITERAL(3, 63, 7), // "pointer"
QT_MOC_LITERAL(4, 71, 22), // "customParameterRemoved"
QT_MOC_LITERAL(5, 94, 24), // "customParameterAddedSlot"
QT_MOC_LITERAL(6, 119, 26), // "customParameterRemovedSlot"
QT_MOC_LITERAL(7, 146, 10), // "addClicked"
QT_MOC_LITERAL(8, 157, 13), // "deleteClicked"
QT_MOC_LITERAL(9, 171, 11), // "itemChanged"
QT_MOC_LITERAL(10, 183, 16), // "QTreeWidgetItem*"
QT_MOC_LITERAL(11, 200, 4), // "item"
QT_MOC_LITERAL(12, 205, 6) // "column"

    },
    "cedar::proc::gui::GroupParameterDesigner\0"
    "customParameterAdded\0\0pointer\0"
    "customParameterRemoved\0customParameterAddedSlot\0"
    "customParameterRemovedSlot\0addClicked\0"
    "deleteClicked\0itemChanged\0QTreeWidgetItem*\0"
    "item\0column"
};
...
void cedar::proc::gui::GroupParameterDesigner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GroupParameterDesigner::*_t)(QVariant );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupParameterDesigner::customParameterAdded)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (GroupParameterDesigner::*_t)(QVariant );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupParameterDesigner::customParameterRemoved)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject cedar::proc::gui::GroupParameterDesigner::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__proc__gui__GroupParameterDesigner.data,
      qt_meta_data_cedar__proc__gui__GroupParameterDesigner,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::gui::GroupParameterDesigner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__gui__GroupParameterDesigner.stringdata0))
