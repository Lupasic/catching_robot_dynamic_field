...
struct qt_meta_stringdata_cedar__proc__sources__GaussInput_t {
    QByteArrayData data[5];
    char stringdata0[85];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__proc__sources__GaussInput_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__proc__sources__GaussInput_t qt_meta_stringdata_cedar__proc__sources__GaussInput = {
    {
QT_MOC_LITERAL(0, 0, 32), // "cedar::proc::sources::GaussInput"
QT_MOC_LITERAL(1, 33, 12), // "updateMatrix"
QT_MOC_LITERAL(2, 46, 0), // ""
QT_MOC_LITERAL(3, 47, 16), // "updateMatrixSize"
QT_MOC_LITERAL(4, 64, 20) // "updateDimensionality"

    },
    "cedar::proc::sources::GaussInput\0"
...
const QMetaObject cedar::proc::sources::GaussInput::staticMetaObject = {
    { &cedar::proc::Step::staticMetaObject, qt_meta_stringdata_cedar__proc__sources__GaussInput.data,
      qt_meta_data_cedar__proc__sources__GaussInput,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::sources::GaussInput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__sources__GaussInput.stringdata0))
