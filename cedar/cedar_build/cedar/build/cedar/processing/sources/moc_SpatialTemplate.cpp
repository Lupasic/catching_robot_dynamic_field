...
void cedar::proc::sources::SpatialTemplate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SpatialTemplate *_t = static_cast<SpatialTemplate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject cedar::proc::sources::SpatialTemplate::staticMetaObject = {
    { &cedar::proc::Step::staticMetaObject, qt_meta_stringdata_cedar__proc__sources__SpatialTemplate.data,
      qt_meta_data_cedar__proc__sources__SpatialTemplate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::sources::SpatialTemplate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__sources__SpatialTemplate.stringdata0))
        return static_cast<void*>(const_cast< SpatialTemplate*>(this));
