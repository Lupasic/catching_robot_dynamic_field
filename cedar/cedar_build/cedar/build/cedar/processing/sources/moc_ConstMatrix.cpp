...
void cedar::proc::sources::ConstMatrix::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ConstMatrix *_t = static_cast<ConstMatrix *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject cedar::proc::sources::ConstMatrix::staticMetaObject = {
    { &cedar::proc::Step::staticMetaObject, qt_meta_stringdata_cedar__proc__sources__ConstMatrix.data,
      qt_meta_data_cedar__proc__sources__ConstMatrix,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::sources::ConstMatrix::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__sources__ConstMatrix.stringdata0))
        return static_cast<void*>(const_cast< ConstMatrix*>(this));
