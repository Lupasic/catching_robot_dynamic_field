...
const QMetaObject cedar::proc::steps::AnglesOnPlane::staticMetaObject = {
    { &cedar::proc::Step::staticMetaObject, qt_meta_stringdata_cedar__proc__steps__AnglesOnPlane.data,
      qt_meta_data_cedar__proc__steps__AnglesOnPlane,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::steps::AnglesOnPlane::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__steps__AnglesOnPlane.stringdata0))
        return static_cast<void*>(const_cast< AnglesOnPlane*>(this));
