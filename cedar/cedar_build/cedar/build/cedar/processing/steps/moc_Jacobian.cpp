...
void cedar::proc::steps::Jacobian::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Jacobian *_t = static_cast<Jacobian *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject cedar::proc::steps::Jacobian::staticMetaObject = {
    { &cedar::proc::Step::staticMetaObject, qt_meta_stringdata_cedar__proc__steps__Jacobian.data,
      qt_meta_data_cedar__proc__steps__Jacobian,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::steps::Jacobian::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__steps__Jacobian.stringdata0))
        return static_cast<void*>(const_cast< Jacobian*>(this));
