...
struct qt_meta_stringdata_cedar__proc__experiment__gui__ActionSequence_t {
    QByteArrayData data[5];
    char stringdata0[76];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__proc__experiment__gui__ActionSequence_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__proc__experiment__gui__ActionSequence_t qt_meta_stringdata_cedar__proc__experiment__gui__ActionSequence = {
    {
QT_MOC_LITERAL(0, 0, 44), // "cedar::proc::experiment::gui:..."
QT_MOC_LITERAL(1, 45, 6), // "update"
QT_MOC_LITERAL(2, 52, 0), // ""
QT_MOC_LITERAL(3, 53, 6), // "remove"
QT_MOC_LITERAL(4, 60, 15) // "updateCondition"

    },
    "cedar::proc::experiment::gui::ActionSequence\0"
    "update\0\0remove\0updateCondition"
};
...
const QMetaObject cedar::proc::experiment::gui::ActionSequence::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_cedar__proc__experiment__gui__ActionSequence.data,
      qt_meta_data_cedar__proc__experiment__gui__ActionSequence,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::experiment::gui::ActionSequence::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__experiment__gui__ActionSequence.stringdata0))
