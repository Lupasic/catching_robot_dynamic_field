...
struct qt_meta_stringdata_cedar__proc__experiment__PropertyParameter_t {
    QByteArrayData data[1];
    char stringdata0[43];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__proc__experiment__PropertyParameter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__proc__experiment__PropertyParameter_t qt_meta_stringdata_cedar__proc__experiment__PropertyParameter = {
    {
QT_MOC_LITERAL(0, 0, 42) // "cedar::proc::experiment::Prop..."

    },
    "cedar::proc::experiment::PropertyParameter"
};
...
const QMetaObject cedar::proc::experiment::PropertyParameter::staticMetaObject = {
    { &cedar::aux::Parameter::staticMetaObject, qt_meta_stringdata_cedar__proc__experiment__PropertyParameter.data,
      qt_meta_data_cedar__proc__experiment__PropertyParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::experiment::PropertyParameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__experiment__PropertyParameter.stringdata0))
