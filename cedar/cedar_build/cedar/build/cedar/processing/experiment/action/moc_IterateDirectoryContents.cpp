...
struct qt_meta_stringdata_cedar__proc__experiment__action__IterateDirectoryContents_t {
    QByteArrayData data[3];
    char stringdata0[83];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__proc__experiment__action__IterateDirectoryContents_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__proc__experiment__action__IterateDirectoryContents_t qt_meta_stringdata_cedar__proc__experiment__action__IterateDirectoryContents = {
    {
QT_MOC_LITERAL(0, 0, 57), // "cedar::proc::experiment::acti..."
QT_MOC_LITERAL(1, 58, 23), // "updateDirectoryContents"
QT_MOC_LITERAL(2, 82, 0) // ""

    },
    "cedar::proc::experiment::action::IterateDirectoryContents\0"
    "updateDirectoryContents\0"
};
...
const QMetaObject cedar::proc::experiment::action::IterateDirectoryContents::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__proc__experiment__action__IterateDirectoryContents.data,
      qt_meta_data_cedar__proc__experiment__action__IterateDirectoryContents,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::proc::experiment::action::IterateDirectoryContents::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__proc__experiment__action__IterateDirectoryContents.stringdata0))
