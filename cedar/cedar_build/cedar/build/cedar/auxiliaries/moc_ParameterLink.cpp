...
struct qt_meta_stringdata_cedar__aux__ParameterLink_t {
    QByteArrayData data[6];
    char stringdata0[111];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__aux__ParameterLink_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__aux__ParameterLink_t qt_meta_stringdata_cedar__aux__ParameterLink = {
    {
QT_MOC_LITERAL(0, 0, 25), // "cedar::aux::ParameterLink"
QT_MOC_LITERAL(1, 26, 17), // "callSourceChanged"
QT_MOC_LITERAL(2, 44, 0), // ""
QT_MOC_LITERAL(3, 45, 17), // "callTargetChanged"
QT_MOC_LITERAL(4, 63, 23), // "sourcePropertiesChanged"
QT_MOC_LITERAL(5, 87, 23) // "targetPropertiesChanged"

    },
    "cedar::aux::ParameterLink\0callSourceChanged\0"
    "\0callTargetChanged\0sourcePropertiesChanged\0"
...
const QMetaObject cedar::aux::ParameterLink::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__aux__ParameterLink.data,
      qt_meta_data_cedar__aux__ParameterLink,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::ParameterLink::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__ParameterLink.stringdata0))
