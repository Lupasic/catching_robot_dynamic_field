...
struct qt_meta_stringdata_cedar__aux__detail__CallFunctionInThreadALotWorker_t {
    QByteArrayData data[3];
    char stringdata0[64];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__aux__detail__CallFunctionInThreadALotWorker_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__aux__detail__CallFunctionInThreadALotWorker_t qt_meta_stringdata_cedar__aux__detail__CallFunctionInThreadALotWorker = {
    {
QT_MOC_LITERAL(0, 0, 50), // "cedar::aux::detail::CallFunct..."
QT_MOC_LITERAL(1, 51, 11), // "executeSlot"
...
const QMetaObject cedar::aux::detail::CallFunctionInThreadALotWorker::staticMetaObject = {
    { &cedar::aux::detail::ThreadWorker::staticMetaObject, qt_meta_stringdata_cedar__aux__detail__CallFunctionInThreadALotWorker.data,
      qt_meta_data_cedar__aux__detail__CallFunctionInThreadALotWorker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::detail::CallFunctionInThreadALotWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__detail__CallFunctionInThreadALotWorker.stringdata0))
        return static_cast<void*>(const_cast< CallFunctionInThreadALotWorker*>(this));
    return cedar::aux::detail::ThreadWorker::qt_metacast(_clname);
}

int cedar::aux::detail::CallFunctionInThreadALotWorker::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = cedar::aux::detail::ThreadWorker::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
