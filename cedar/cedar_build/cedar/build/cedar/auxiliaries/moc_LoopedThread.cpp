...
struct qt_meta_stringdata_cedar__aux__LoopedThread_t {
    QByteArrayData data[3];
    char stringdata0[38];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__aux__LoopedThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__aux__LoopedThread_t qt_meta_stringdata_cedar__aux__LoopedThread = {
    {
QT_MOC_LITERAL(0, 0, 24), // "cedar::aux::LoopedThread"
QT_MOC_LITERAL(1, 25, 11), // "modeChanged"
QT_MOC_LITERAL(2, 37, 0) // ""

    },
    "cedar::aux::LoopedThread\0modeChanged\0"
    ""
};
...
const QMetaObject cedar::aux::LoopedThread::staticMetaObject = {
    { &cedar::aux::ThreadWrapper::staticMetaObject, qt_meta_stringdata_cedar__aux__LoopedThread.data,
      qt_meta_data_cedar__aux__LoopedThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::LoopedThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__LoopedThread.stringdata0))
