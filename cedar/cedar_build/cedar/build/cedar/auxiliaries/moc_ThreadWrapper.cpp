...
void cedar::aux::ThreadWrapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ThreadWrapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThreadWrapper::finishedThread)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject cedar::aux::ThreadWrapper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__aux__ThreadWrapper.data,
      qt_meta_data_cedar__aux__ThreadWrapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
