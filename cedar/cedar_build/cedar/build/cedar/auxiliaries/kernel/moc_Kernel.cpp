...
struct qt_meta_stringdata_cedar__aux__kernel__Kernel_t {
    QByteArrayData data[5];
    char stringdata0[77];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__aux__kernel__Kernel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__aux__kernel__Kernel_t qt_meta_stringdata_cedar__aux__kernel__Kernel = {
    {
QT_MOC_LITERAL(0, 0, 26), // "cedar::aux::kernel::Kernel"
QT_MOC_LITERAL(1, 27, 13), // "kernelUpdated"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 12), // "updateKernel"
QT_MOC_LITERAL(4, 55, 21) // "dimensionalityChanged"

    },
    "cedar::aux::kernel::Kernel\0kernelUpdated\0"
    "\0updateKernel\0dimensionalityChanged"
};
...
void cedar::aux::kernel::Kernel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Kernel::kernelUpdated)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject cedar::aux::kernel::Kernel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__aux__kernel__Kernel.data,
      qt_meta_data_cedar__aux__kernel__Kernel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::kernel::Kernel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__kernel__Kernel.stringdata0))
