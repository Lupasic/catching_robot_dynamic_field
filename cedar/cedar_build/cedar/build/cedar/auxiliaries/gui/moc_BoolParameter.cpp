...
struct qt_meta_stringdata_cedar__aux__gui__BoolParameter_t {
    QByteArrayData data[6];
    char stringdata0[97];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__aux__gui__BoolParameter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__aux__gui__BoolParameter_t qt_meta_stringdata_cedar__aux__gui__BoolParameter = {
    {
QT_MOC_LITERAL(0, 0, 30), // "cedar::aux::gui::BoolParameter"
QT_MOC_LITERAL(1, 31, 23), // "parameterPointerChanged"
QT_MOC_LITERAL(2, 55, 0), // ""
QT_MOC_LITERAL(3, 56, 12), // "stateChanged"
QT_MOC_LITERAL(4, 69, 5), // "state"
QT_MOC_LITERAL(5, 75, 21) // "parameterValueChanged"

    },
    "cedar::aux::gui::BoolParameter\0"
    "parameterPointerChanged\0\0stateChanged\0"
    "state\0parameterValueChanged"
};
...
const QMetaObject cedar::aux::gui::BoolParameter::staticMetaObject = {
    { &cedar::aux::gui::Parameter::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__BoolParameter.data,
      qt_meta_data_cedar__aux__gui__BoolParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::BoolParameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__BoolParameter.stringdata0))
