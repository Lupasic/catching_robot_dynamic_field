...
void cedar::aux::gui::FileParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FileParameter *_t = static_cast<FileParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject cedar::aux::gui::FileParameter::staticMetaObject = {
    { &cedar::aux::gui::Parameter::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__FileParameter.data,
      qt_meta_data_cedar__aux__gui__FileParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::FileParameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__FileParameter.stringdata0))
        return static_cast<void*>(const_cast< FileParameter*>(this));
