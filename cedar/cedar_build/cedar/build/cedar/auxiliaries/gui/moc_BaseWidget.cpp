...
struct qt_meta_stringdata_cedar__aux__gui__BaseWidget_t {
    QByteArrayData data[3];
    char stringdata0[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__aux__gui__BaseWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__aux__gui__BaseWidget_t qt_meta_stringdata_cedar__aux__gui__BaseWidget = {
    {
QT_MOC_LITERAL(0, 0, 27), // "cedar::aux::gui::BaseWidget"
QT_MOC_LITERAL(1, 28, 17), // "visibilityChanged"
QT_MOC_LITERAL(2, 46, 0) // ""

    },
    "cedar::aux::gui::BaseWidget\0"
    "visibilityChanged\0"
};
...
void cedar::aux::gui::BaseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (BaseWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BaseWidget::visibilityChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject cedar::aux::gui::BaseWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__BaseWidget.data,
      qt_meta_data_cedar__aux__gui__BaseWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::BaseWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__BaseWidget.stringdata0))
