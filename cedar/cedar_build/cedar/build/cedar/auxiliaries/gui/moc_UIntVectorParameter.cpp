...
struct qt_meta_stringdata_cedar__aux__gui__UIntVectorParameter_t {
    QByteArrayData data[3];
    char stringdata0[57];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__aux__gui__UIntVectorParameter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__aux__gui__UIntVectorParameter_t qt_meta_stringdata_cedar__aux__gui__UIntVectorParameter = {
    {
QT_MOC_LITERAL(0, 0, 36), // "cedar::aux::gui::UIntVectorPa..."
...
const QMetaObject cedar::aux::gui::UIntVectorParameter::staticMetaObject = {
    { &cedar::aux::gui::NumericVectorParameter<unsigned int,QSpinBox>::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__UIntVectorParameter.data,
      qt_meta_data_cedar__aux__gui__UIntVectorParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::UIntVectorParameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__UIntVectorParameter.stringdata0))
        return static_cast<void*>(const_cast< UIntVectorParameter*>(this));
    return cedar::aux::gui::NumericVectorParameter<unsigned int,QSpinBox>::qt_metacast(_clname);
}

int cedar::aux::gui::UIntVectorParameter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = cedar::aux::gui::NumericVectorParameter<unsigned int,QSpinBox>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
