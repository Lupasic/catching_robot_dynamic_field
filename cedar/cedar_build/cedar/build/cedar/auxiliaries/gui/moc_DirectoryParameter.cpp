...
struct qt_meta_stringdata_cedar__aux__gui__DirectoryParameter_t {
    QByteArrayData data[5];
    char stringdata0[99];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__aux__gui__DirectoryParameter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__aux__gui__DirectoryParameter_t qt_meta_stringdata_cedar__aux__gui__DirectoryParameter = {
    {
QT_MOC_LITERAL(0, 0, 35), // "cedar::aux::gui::DirectoryPar..."
QT_MOC_LITERAL(1, 36, 15), // "onBrowseClicked"
QT_MOC_LITERAL(2, 52, 0), // ""
QT_MOC_LITERAL(3, 53, 23), // "parameterPointerChanged"
QT_MOC_LITERAL(4, 77, 21) // "parameterValueChanged"

    },
    "cedar::aux::gui::DirectoryParameter\0"
    "onBrowseClicked\0\0parameterPointerChanged\0"
...
const QMetaObject cedar::aux::gui::DirectoryParameter::staticMetaObject = {
    { &cedar::aux::gui::Parameter::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__DirectoryParameter.data,
      qt_meta_data_cedar__aux__gui__DirectoryParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::DirectoryParameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__DirectoryParameter.stringdata0))
