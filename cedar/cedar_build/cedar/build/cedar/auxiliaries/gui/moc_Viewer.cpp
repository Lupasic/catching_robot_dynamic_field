...
struct qt_meta_stringdata_cedar__aux__gui__Viewer_t {
    QByteArrayData data[1];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__aux__gui__Viewer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__aux__gui__Viewer_t qt_meta_stringdata_cedar__aux__gui__Viewer = {
    {
QT_MOC_LITERAL(0, 0, 23) // "cedar::aux::gui::Viewer"
...
const QMetaObject cedar::aux::gui::Viewer::staticMetaObject = {
    { &QGLViewer::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__Viewer.data,
      qt_meta_data_cedar__aux__gui__Viewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::Viewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__Viewer.stringdata0))
