...
void cedar::aux::gui::ObjectParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ObjectParameter *_t = static_cast<ObjectParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject cedar::aux::gui::ObjectParameter::staticMetaObject = {
    { &cedar::aux::gui::Parameter::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__ObjectParameter.data,
      qt_meta_data_cedar__aux__gui__ObjectParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::ObjectParameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__ObjectParameter.stringdata0))
        return static_cast<void*>(const_cast< ObjectParameter*>(this));
