...
void cedar::aux::gui::QwtMatrixPlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QwtMatrixPlot *_t = static_cast<QwtMatrixPlot *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject cedar::aux::gui::QwtMatrixPlot::staticMetaObject = {
    { &cedar::aux::gui::MultiPlotInterface::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__QwtMatrixPlot.data,
      qt_meta_data_cedar__aux__gui__QwtMatrixPlot,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::QwtMatrixPlot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__QwtMatrixPlot.stringdata0))
        return static_cast<void*>(const_cast< QwtMatrixPlot*>(this));
