...
void cedar::aux::gui::IntVectorParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        IntVectorParameter *_t = static_cast<IntVectorParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject cedar::aux::gui::IntVectorParameter::staticMetaObject = {
    { &cedar::aux::gui::NumericVectorParameter<int,QSpinBox>::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__IntVectorParameter.data,
      qt_meta_data_cedar__aux__gui__IntVectorParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
