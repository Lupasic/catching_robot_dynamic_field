...
const QMetaObject cedar::aux::gui::SceneControl::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__SceneControl.data,
      qt_meta_data_cedar__aux__gui__SceneControl,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::SceneControl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__SceneControl.stringdata0))
        return static_cast<void*>(const_cast< SceneControl*>(this));
