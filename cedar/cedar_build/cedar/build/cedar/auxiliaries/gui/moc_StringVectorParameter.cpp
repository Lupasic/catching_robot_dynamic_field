...
const QMetaObject cedar::aux::gui::StringVectorParameter::staticMetaObject = {
    { &cedar::aux::gui::VectorParameter<std::string,QLineEdit>::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__StringVectorParameter.data,
      qt_meta_data_cedar__aux__gui__StringVectorParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
