...
void cedar::aux::gui::Log::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Log::*_t)(int , QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Log::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject cedar::aux::gui::Log::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__Log.data,
      qt_meta_data_cedar__aux__gui__Log,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
