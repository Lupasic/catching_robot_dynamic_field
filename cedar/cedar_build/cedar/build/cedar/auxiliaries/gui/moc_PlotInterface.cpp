...
void cedar::aux::gui::PlotInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PlotInterface *_t = static_cast<PlotInterface *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (PlotInterface::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PlotInterface::dataChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject cedar::aux::gui::PlotInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__PlotInterface.data,
      qt_meta_data_cedar__aux__gui__PlotInterface,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::PlotInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "cedar::aux::Configurable"))
        return static_cast< cedar::aux::Configurable*>(const_cast< PlotInterface*>(this));
