...
void cedar::aux::gui::FrequencyParameter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FrequencyParameter *_t = static_cast<FrequencyParameter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject cedar::aux::gui::FrequencyParameter::staticMetaObject = {
    { &cedar::aux::gui::NumericParameter<cedar::unit::Frequency,QDoubleSpinBox>::staticMetaObject, qt_meta_stringdata_cedar__aux__gui__FrequencyParameter.data,
      qt_meta_data_cedar__aux__gui__FrequencyParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::aux::gui::FrequencyParameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__aux__gui__FrequencyParameter.stringdata0))
        return static_cast<void*>(const_cast< FrequencyParameter*>(this));
