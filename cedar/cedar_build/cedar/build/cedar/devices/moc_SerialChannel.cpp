...
struct qt_meta_stringdata_cedar__dev__SerialChannel_t {
    QByteArrayData data[3];
    char stringdata0[50];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__dev__SerialChannel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__dev__SerialChannel_t qt_meta_stringdata_cedar__dev__SerialChannel = {
    {
QT_MOC_LITERAL(0, 0, 25), // "cedar::dev::SerialChannel"
QT_MOC_LITERAL(1, 26, 22), // "updateCommandDelimiter"
QT_MOC_LITERAL(2, 49, 0) // ""

    },
    "cedar::dev::SerialChannel\0"
...
const QMetaObject cedar::dev::SerialChannel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cedar__dev__SerialChannel.data,
      qt_meta_data_cedar__dev__SerialChannel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::dev::SerialChannel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__dev__SerialChannel.stringdata0))
        return static_cast<void*>(const_cast< SerialChannel*>(this));
    if (!strcmp(_clname, "cedar::dev::Channel"))
        return static_cast< cedar::dev::Channel*>(const_cast< SerialChannel*>(this));
