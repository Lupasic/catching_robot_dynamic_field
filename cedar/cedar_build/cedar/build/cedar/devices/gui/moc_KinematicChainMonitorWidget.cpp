...
struct qt_meta_stringdata_cedar__dev__gui__KinematicChainMonitorWidget_t {
    QByteArrayData data[3];
    char stringdata0[53];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__dev__gui__KinematicChainMonitorWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__dev__gui__KinematicChainMonitorWidget_t qt_meta_stringdata_cedar__dev__gui__KinematicChainMonitorWidget = {
    {
...
const QMetaObject cedar::dev::gui::KinematicChainMonitorWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cedar__dev__gui__KinematicChainMonitorWidget.data,
      qt_meta_data_cedar__dev__gui__KinematicChainMonitorWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::dev::gui::KinematicChainMonitorWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__dev__gui__KinematicChainMonitorWidget.stringdata0))
