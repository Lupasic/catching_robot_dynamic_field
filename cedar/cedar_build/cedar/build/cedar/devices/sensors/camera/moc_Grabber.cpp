...
void cedar::dev::sensors::camera::Grabber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Grabber::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Grabber::frameSizeChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject cedar::dev::sensors::camera::Grabber::staticMetaObject = {
    { &cedar::dev::sensors::visual::Grabber::staticMetaObject, qt_meta_stringdata_cedar__dev__sensors__camera__Grabber.data,
      qt_meta_data_cedar__dev__sensors__camera__Grabber,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
