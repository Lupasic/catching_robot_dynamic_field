...
struct qt_meta_stringdata_cedar__dyn__NeuralField_t {
    QByteArrayData data[6];
    char stringdata0[116];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__dyn__NeuralField_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__dyn__NeuralField_t qt_meta_stringdata_cedar__dyn__NeuralField = {
    {
QT_MOC_LITERAL(0, 0, 23), // "cedar::dyn::NeuralField"
QT_MOC_LITERAL(1, 24, 21), // "dimensionalityChanged"
QT_MOC_LITERAL(2, 46, 0), // ""
QT_MOC_LITERAL(3, 47, 20), // "dimensionSizeChanged"
QT_MOC_LITERAL(4, 68, 25), // "activationAsOutputChanged"
QT_MOC_LITERAL(5, 94, 21) // "discreteMetricChanged"

    },
    "cedar::dyn::NeuralField\0dimensionalityChanged\0"
    "\0dimensionSizeChanged\0activationAsOutputChanged\0"
...
const QMetaObject cedar::dyn::NeuralField::staticMetaObject = {
    { &cedar::dyn::Dynamics::staticMetaObject, qt_meta_stringdata_cedar__dyn__NeuralField.data,
      qt_meta_data_cedar__dyn__NeuralField,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::dyn::NeuralField::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__dyn__NeuralField.stringdata0))
