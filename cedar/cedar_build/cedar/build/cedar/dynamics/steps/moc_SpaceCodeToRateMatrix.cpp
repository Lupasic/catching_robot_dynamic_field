...
struct qt_meta_stringdata_cedar__dyn__SpaceCodeToRateMatrix_t {
    QByteArrayData data[4];
    char stringdata0[68];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cedar__dyn__SpaceCodeToRateMatrix_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cedar__dyn__SpaceCodeToRateMatrix_t qt_meta_stringdata_cedar__dyn__SpaceCodeToRateMatrix = {
    {
QT_MOC_LITERAL(0, 0, 33), // "cedar::dyn::SpaceCodeToRateMa..."
QT_MOC_LITERAL(1, 34, 13), // "limitsChanged"
QT_MOC_LITERAL(2, 48, 0), // ""
QT_MOC_LITERAL(3, 49, 18) // "outputSizesChanged"

    },
    "cedar::dyn::SpaceCodeToRateMatrix\0"
...
const QMetaObject cedar::dyn::SpaceCodeToRateMatrix::staticMetaObject = {
    { &cedar::proc::Step::staticMetaObject, qt_meta_stringdata_cedar__dyn__SpaceCodeToRateMatrix.data,
      qt_meta_data_cedar__dyn__SpaceCodeToRateMatrix,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::dyn::SpaceCodeToRateMatrix::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__dyn__SpaceCodeToRateMatrix.stringdata0))
