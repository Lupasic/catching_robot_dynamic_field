...
const QMetaObject cedar::dyn::steps::LogTimeInterval::staticMetaObject = {
    { &cedar::dyn::Dynamics::staticMetaObject, qt_meta_stringdata_cedar__dyn__steps__LogTimeInterval.data,
      qt_meta_data_cedar__dyn__steps__LogTimeInterval,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cedar::dyn::steps::LogTimeInterval::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cedar__dyn__steps__LogTimeInterval.stringdata0))
        return static_cast<void*>(const_cast< LogTimeInterval*>(this));
