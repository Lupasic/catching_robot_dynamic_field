...
struct qt_meta_stringdata_BoolVectorParameter_t {
    QByteArrayData data[1];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BoolVectorParameter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BoolVectorParameter_t qt_meta_stringdata_BoolVectorParameter = {
    {
QT_MOC_LITERAL(0, 0, 19) // "BoolVectorParameter"
...
const QMetaObject BoolVectorParameter::staticMetaObject = {
    { &cedar::aux::gui::BoolVectorParameter::staticMetaObject, qt_meta_stringdata_BoolVectorParameter.data,
      qt_meta_data_BoolVectorParameter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BoolVectorParameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BoolVectorParameter.stringdata0))
        return static_cast<void*>(const_cast< BoolVectorParameter*>(this));
    return cedar::aux::gui::BoolVectorParameter::qt_metacast(_clname);
}

int BoolVectorParameter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = cedar::aux::gui::BoolVectorParameter::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
